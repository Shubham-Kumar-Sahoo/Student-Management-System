...
frame_bg_color = '#28282B'  # Matte Black  background for frames
header_bg_color = '#333333'  # dark grey for header
header_fg_color = '#ffffff'  # white text for header
button_bg_color = '#4CAF50'  # green buttons
button_fg_color = '#000000'  # black text for buttons
...
Label(main, text="SCHOOL MANAGEMENT SYSTEM", font=headlabelfont, bg=header_bg_color, fg=header_fg_color).pack(side=TOP, fill=X)

left_frame = Frame(main, bg=frame_bg_color)
left_frame.place(x=0, y=30, relheight=1, relwidth=0.2)
center_frame = Frame(main, bg=frame_bg_color)
center_frame.place(relx=0.2, y=30, relheight=1, relwidth=0.2)
right_frame = Frame(main, bg=frame_bg_color)
right_frame.place(relx=0.4, y=30, relheight=1, relwidth=0.6)

# Placing components in the left frame
Label(left_frame, text="Name", font=labelfont, bg=frame_bg_color).place(relx=0.375, rely=0.05)
Label(left_frame, text="Contact Number", font=labelfont, bg=frame_bg_color).place(relx=0.175, rely=0.18)
Label(left_frame, text="Email Address", font=labelfont, bg=frame_bg_color).place(relx=0.2, rely=0.31)
Label(left_frame, text="Gender", font=labelfont, bg=frame_bg_color).place(relx=0.3, rely=0.44)
Label(left_frame, text="Date of Birth (DOB)", font=labelfont, bg=frame_bg_color).place(relx=0.1, rely=0.57)
Label(left_frame, text="Stream", font=labelfont, bg=frame_bg_color).place(relx=0.3, rely=0.7)
...
Button(left_frame, text='Submit and Add Record', font=labelfont, command=add_record, width=18, bg=button_bg_color, fg=button_fg_color).place(relx=0.025, rely=0.85)

# Placing components in the center frame
Button(center_frame, text='Delete Record', font=labelfont, command=remove_record, width=15, bg=button_bg_color, fg=button_fg_color).place(relx=0.1, rely=0.25)
Button(center_frame, text='View Record', font=labelfont, command=view_record, width=15, bg=button_bg_color, fg=button_fg_color).place(relx=0.1, rely=0.35)
Button(center_frame, text='Reset Fields', font=labelfont, command=reset_fields, width=15, bg=button_bg_color, fg=button_fg_color).place(relx=0.1, rely=0.45)
Button(center_frame, text='Delete database', font=labelfont, command=reset_form, width=15, bg=button_bg_color, fg=button_fg_color).place(relx=0.1, rely=0.55)

# Placing components in the right frame
Label(right_frame, text='Students Records', font=headlabelfont, bg=header_bg_color, fg=header_fg_color).pack(side=TOP, fill=X)
